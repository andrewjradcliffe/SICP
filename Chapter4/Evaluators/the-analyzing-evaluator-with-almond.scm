...
#|
In essence, add all the niceties of derived expressions. "almond" is a convenient
signifier (and fuzzy-find target) for the source of added syntax.
|#


(load "~/aradclif/scheme-projects/SICP/Chapter4/Evaluators/the-vanilla-with-almond-evaluator.scm")
