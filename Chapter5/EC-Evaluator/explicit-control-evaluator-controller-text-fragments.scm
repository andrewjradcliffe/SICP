;; individual entry points and instructions for the explicit-control evaluator
#|
This enables modular modification to the explicit control evaluator.
The eceval-controller-text should be constructed with quasiquote and splicing.
|#
